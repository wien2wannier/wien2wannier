...
%
  ...
  \begin{flin}[T]{iwan, rot \rem{(free format)}}{\wf index, apply \wf
      rotation?}
    iwan & int & index of the \wf to be plotted, unless overridden on
                 command line\\
    rot  & logical & read unitary matrix from \file{\case.wfrot} and
...
%%% Time-stamp: <2016-02-03 16:23:15 assman@faepop36.tu-graz.ac.at>
