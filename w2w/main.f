...
!          write(*,*)"nnkp",i,KP(I),KPB(I),BQX1(I),BQY1(I),BQZ1(I)
        enddo
       endif
       goto 113
 114   continue
...
!
      CALL OUTERR('w2w','MULT .EQ. 0')
      GOTO 999
  950 INFO = 5
      CALL OUTERR('w2w','Too many atoms (NATO too small).')
      GOTO 999
  955 INFO = 6
      CALL OUTERR('w2w','Too many atoms (NDIF too small).')
      GOTO 999
  956 INFO = 56
      CALL OUTERR('w2w','LXDOS must be 3 for ISPLIT=999.')
      GOTO 999
  960 INFO = 7
...
!                                                                       
 ...
 1040 FORMAT(///,3X,'ERROR IN w2w : MULT(JATOM)=0 ...',                &
 ...
 6000 FORMAT(///,3X,'ERROR IN w2w : MULT(JATOM)=0 ...', &
             /, 20X,'JATOM=',I3,3X,'INDEX=',I3,3X,'MULT=',I3)
